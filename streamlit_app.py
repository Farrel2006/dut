...
# =====================================
    ...
    # =====================================
        ...
        if st.button("Hitung"):
            ...
            <div class='result'>
            <h3>Langkah Penyelesaian</h3>
            Data ΔH = {[fmt(x) for x in arr]}<br><br>
            ΣΔH = <b>{fmt(total)} kJ</b>
            </div>
            """, unsafe_allow_html=True)
    ...
    # =====================================
        ...
        st.info("ΔH reaksi menunjukkan perubahan kalor selama reaksi kimia berlangsung.")
        ...
        if st.button("Hitung") and p and r:
            ...
            <div class='result'>
            <h3>Langkah Penyelesaian</h3>
            ΣProduk = {fmt(sum(p))}<br>ΣReaktan = {fmt(sum(r))}<br><br>
            ΔH = <b>{fmt(hasil)} kJ/mol</b>
            </div>
            """, unsafe_allow_html=True)
    ...
    # =====================================
        ...
        st.info("Energi Gibbs digunakan untuk menentukan apakah suatu reaksi berlangsung spontan atau tidak.")
        ...
        if st.button("Hitung"):
            ...
            <h3>Langkah Penyelesaian</h3>
            ΔG = ΔH − TΔS <br><br>
            ΔH = {fmt(dH)}<br>T = {fmt(T)}<br>ΔS = {fmt(dS)}<br><br>
            ΔG = <b>{fmt(hasil)} kJ</b>
            </div>
            """, unsafe_allow_html=True)
    ...
    # =====================================
        ...
        st.info("Entropi adalah ukuran tingkat ketidakteraturan suatu sistem.")
    ...
    # =====================================
        ...
        st.info("Gas ideal adalah model gas teoritis yang partikel-partikelnya tidak memiliki gaya tarik dan tumbukannya elastis sempurna.")
        st.latex(r"PV = nRT")
        ...
        if st.button("Hitung"):
            ...
            <h3>Langkah Penyelesaian</h3>
            P = nRT / V <br><br>
            n = {fmt(n)}<br>T = {fmt(T)}<br>V = {fmt(V)}<br>R = 0.0821<br><br>
            P = <b>{fmt(P)} atm</b>
            </div>
            """, unsafe_allow_html=True)
    ...
    # =====================================
        ...
        st.info("Gas nyata adalah gas yang memperhitungkan volume partikel dan gaya tarik antar molekul.")
        ...
        if st.button("Hitung"):
            ...
            P = ((n * R * T) / (V - n * b)) - ((a * n**2) / (V**2)) if (V - n * b) != 0 and V != 0 else 0
            st.balloons()
            st.markdown(f"""
            <div class='result'>
            <h3>Langkah Penyelesaian</h3>
